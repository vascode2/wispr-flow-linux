...
#     * status-window-mouse-vacuum.sh -> self-heal invisible click-eating Status window
#   renderer bundles:
...
MARKERS=(
  ...
  "status-window: invisible-window mouse vacuum watchdog|F|WISPR_STATUS_VIS_BT"
)
